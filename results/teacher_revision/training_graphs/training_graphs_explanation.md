...
## Вывод
Анализ графиков обучения показывает, что модель достигает устойчивой сходимости без выраженного переобучения.

Validation error использовался как основной критерий выбора оптимальной эпохи обучения.
